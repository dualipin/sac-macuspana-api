...
class RegistroCiudadanoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'calle', 'numero_exterior', 'numero_interior', 'localidad',
            'usuario'
        ]
...
class CiudadanoUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate_email(self, value):
        ...
        if existing and existing.id != self.instance.id:
            raise serializers.ValidationError('Este email ya está registrado para otro ciudadano')
...
class CiudadanoDireccionUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Ciudadano
        fields = ['calle', 'numero_exterior', 'numero_interior', 'localidad_id', 'codigo_postal']
        extra_kwargs = {
            'numero_interior': {'required': False, 'allow_blank': True}
        }
    ...
    def validate(self, attrs):
        ...
        if localidad.municipio.upper() != 'MACUSPANA' or localidad.estado.upper() != 'TABASCO':
            raise serializers.ValidationError(
